...
export const testimonialData: TestimonialItem[] = [
  ...
  },
  {
    ...
    testimonial: `Mon beau-père lance une entreprise de construction et nous parcourions les thèmes Astro pour son site
      lorsque nous sommes tombés sur les ressources IoniaScience. Travail incroyable.
      `,
  },
];
