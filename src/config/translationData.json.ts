...
export const textTranslations = {
  en: {
    hero_description: `Research highlights, missions, and tools from the Ionia Labs science team. Dive into the discoveries moving space science forward.`,
    back_to_all_posts: "Back to all posts",
    updated: "Updated",
  },
  fr: {
    hero_description:
      "Les recherches, missions et outils de l'équipe scientifique d'Ionia Labs. Explorez les découvertes qui font avancer la science spatiale.",
