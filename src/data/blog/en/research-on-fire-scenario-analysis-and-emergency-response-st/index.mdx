...
![Table showing various fire scenarios tested in an L-shaped building.](./figure-2.png)
*Table showing various fire scenarios tested in an L-shaped building.*

![Table showing key factors that ensure safe evacuation during emergencies.](./figure-3.png)
*Table showing key factors that ensure safe evacuation during emergencies.*
