...
![Table showing criteria for including studies based on population, exposure, comparison, and outcomes.](./figure-1.png)
*Table showing criteria for including studies based on population, exposure, comparison, and outcomes.*

![Flowchart showing how studies on ultra-processed food and teen obesity were selected for review and analysis.](./figure-2.png)
*Flowchart showing how studies on ultra-processed food and teen obesity were selected for review and analysis.*
...
![Summary of studies linking ultra-processed food consumption to obesity in teenagers.](./figure-4.png)
*Summary of studies linking ultra-processed food consumption to obesity in teenagers.*
