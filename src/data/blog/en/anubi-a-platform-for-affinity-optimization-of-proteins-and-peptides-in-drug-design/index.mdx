...
![Figure 4. Simulation of antibody mutation during affinity maturation against Cx43 showing mutation sites and changes in binding energy over time.](./figure-1.png)
*Figure 4. Simulation of antibody mutation during affinity maturation against Cx43 showing mutation sites and changes in binding energy over time.*
...
![Figure 5. Monte Carlo simulation of peptide affinity maturation against TIGIT showing initial docking, mutation sites, and binding energy changes during the...](./figure-2.png)
*Figure 5. Monte Carlo simulation of peptide affinity maturation against TIGIT showing initial docking, mutation sites, and binding energy changes during the...*
...
![Figure 1. ANUBI workflow showing how it modifies a protein-ligand structure, tests changes, and selects sequences with improved binding affinity.](./figure-3.png)
*Figure 1. ANUBI workflow showing how it modifies a protein-ligand structure, tests changes, and selects sequences with improved binding affinity.*
...
![Figure 6. Results from 35 ANUBI Monte Carlo runs showing changes in binding energy for the Cx43 antibody complex during the process.](./figure-4.png)
*Figure 6. Results from 35 ANUBI Monte Carlo runs showing changes in binding energy for the Cx43 antibody complex during the process.*
