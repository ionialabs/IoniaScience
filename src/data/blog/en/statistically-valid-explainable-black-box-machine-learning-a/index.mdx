...
![Diagram showing how sex influences brain features, with age, hormones, and species also playing roles, and controlling for brain size differences.](./figure-2.png)
*Diagram showing how sex influences brain features, with age, hormones, and species also playing roles, and controlling for brain size differences.*
...
![Fig 5 shows how well different methods pick features to classify human and macaque Markov CTh data, with accuracy improving as more features are used.](./figure-4.png)
*Fig 5 shows how well different methods pick features to classify human and macaque Markov CTh data, with accuracy improving as more features are used.*
